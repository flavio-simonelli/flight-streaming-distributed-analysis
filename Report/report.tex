...
Nel sistema progettato, impostando $\alpha = 0.01$ (errore massimo dell'1\%) e $m = 2048$ bin, tale approssimazione non rappresenta un problema in alcuno dei due scenari di utilizzo:
\begin{enumerate}
