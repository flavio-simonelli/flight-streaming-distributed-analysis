...
\begin{itemize}
    \item \textbf{Partizionamento e Topic:} Il flusso in ingresso è instradato sul topic primario \texttt{flights-stream}, configurato con 6 partizioni per consentire la scalabilità orizzontale di Flink. I flussi analitici in uscita sono distribuiti su topic dedicati per granularità temporale, disaccoppiando Flink dallo storage a valle.
    ...
    \item \textbf{Scrittura dei Risultati:} Avviene mediante istanze di \texttt{KafkaSink} configurate con garanzia di consegna \textit{at-least-once}, evitando l'overhead di coordinamento delle transazioni distribuite a due fasi.
\end{itemize}
