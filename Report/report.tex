...
\newcommandx{\nodeChart}[4][1=0.95\linewidth]{%
    \begin{figure}[H]
        \centering
        \adjustbox{trim={0.01\width} {0.01\height} {0.00\width} {0.08\height}, clip}{%
            \includegraphics[width=#1]{../Results/charts/#2}%
        }
        \caption{#3}
        \label{#4}
...
\nodeChart{node_chk_run_int5_fail1}{Utilizzo risorse per nodo (Scenario 3 con fallimento al minuto 6).}{fig:node_checkpoint_recovery}
