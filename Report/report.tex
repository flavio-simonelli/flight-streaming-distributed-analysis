...
La topologia logica a grafo aciclico diretto (DAG) generata a runtime da Apache Flink per l'esecuzione parallela e concorrente delle tre query analitiche è illustrata in Fig.~\ref{fig:flink_dag}.

\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.95\textwidth]{graphs/Flink-DAG}
    \caption{Grafo Aciclico Diretto (DAG) della topologia del Job Flink.}
    \label{fig:flink_dag}
\end{figure}
